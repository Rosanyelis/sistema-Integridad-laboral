...
(function () {
  ...
  layoutMenuEl.forEach(function (element) {
    menu = new Menu(element, {
      ...
      showDropdownOnHover: localStorage.getItem('templateCustomizer-' + templateName + '--ShowDropdownOnHover') // If value(showDropdownOnHover) is set in local storage
        ...
        : window.templateCustomizer !== undefined && window.templateCustomizer.settings // If value is set in config.js
  ...
  if (languageDropdown.length) {
    ...
    if (dropdownActiveItem && dropdownActiveItem.dataset) {
    ...
    function directionChange(textDirection) {
      ...
      if (textDirection === 'rtl') {
        if (localStorage.getItem('templateCustomizer-' + templateName + '--Rtl') !== 'true')
          if (window.templateCustomizer && typeof window.templateCustomizer.setRtl === 'function') window.templateCustomizer.setRtl(true);
      } else {
        if (localStorage.getItem('templateCustomizer-' + templateName + '--Rtl') === 'true')
          if (window.templateCustomizer && typeof window.templateCustomizer.setRtl === 'function') window.templateCustomizer.setRtl(false);
      }
    }
  }
