  ...
  plugins: [
    laravel({
      input: [
        ...
        'resources/js/user-index.js', // Processing User Management DataTable JS File
        'resources/js/user-create.js', // Processing User Create Form JS File
        'resources/js/user-edit.js', // Processing User Edit Form JS File
        'resources/js/roles-index.js', // Processing Roles Index DataTable JS File
